...
class NotificationSeeder extends Seeder
{
    public function run(): void
    {
        User::all()->each(function ($user) {
            ...
            <p>[Notification 1] Starting today, you can access these features through your Coinest dashboard. Here's what you can look forward to:</p>
            <ul>
            ...
            <p>[Notification 2] Starting today, you can access these features through your Coinest dashboard. Here's what you can look forward to:</p>
            <ul>
                <li><b>Custom Budget Categories</b>: <i>Tailor your budget</i> to match your spending habits with customizable categories.</li>
                <li><b>Spending Alerts</b>: Set up alerts to notify you when you're close to reaching your budget limit in any category.</li>
                <li><b>Financial Health Score</b>: <span style='color: red'>Use our new tool to get</span> a snapshot of your financial health based on your income, expenses, and savings.</li>
            ...
            <p>[Notification 3] Starting today, you can access these features through your Coinest dashboard. Here's what you can look forward to:</p>
            <ul>
                <li><b>Custom Budget Categories</b>: <i>Tailor your budget</i> to match your spending habits with customizable categories.</li>
                <li><b>Spending Alerts</b>: Set up alerts to notify you when you're close to reaching your budget limit in any category.</li>
                <li><b>Financial Health Score</b>: <span style='color: red'>Use our new tool to get</span> a snapshot of your financial health based on your income, expenses, and savings.</li>
